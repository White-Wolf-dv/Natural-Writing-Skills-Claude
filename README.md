...
Four [Claude Skills](https://docs.claude.com/en/docs/agents-and-tools/agent-skills/overview) that make AI-generated prose read like a person wrote it — for Persian, English, Arabic, and Spanish.
